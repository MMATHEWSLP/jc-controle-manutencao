...
const permissionGroups: Array<{
    ...
    { label: "Tarefas", items: [["tasks.view", "Visualizar tarefas"], ["tasks.create", "Criar tarefas e subtarefas"], ["tasks.edit", "Editar, concluir ou excluir tarefas"], ["tasks.manage", "Visualizar e gerenciar tarefas de todos os usuários"]] },
...
const profileDefaults: Record<"ADMIN" | "GESTOR" | "OFICINA" | "OPERADOR", Permission[]> = { ADMIN: allPermissions, GESTOR: ["dashboard.view", "equipment.view", "meter.view", "maintenance.view", "maintenance.history", "alerts.view", "alerts.share", "whatsapp.view", "whatsapp.send", "fleet.view", "fleet.update", "fleet.report", "materials.view", "materials.manage", "tasks.view", "tasks.create", "tasks.edit", "tasks.manage"], OFICINA: ["equipment.view", "equipment.edit_plan", "meter.view", "meter.create", "maintenance.view", "maintenance.create", "maintenance.edit", "maintenance.history", "alerts.view", "fleet.view", "fleet.update", "fleet.report", "materials.view", "materials.request", "tasks.view", "tasks.create", "tasks.edit"], OPERADOR: [] };
